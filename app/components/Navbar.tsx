        ...
        >
          {[
            ...
            <Link key={href} href={href} onClick={handleLinkClick}>
              <a className="text-white text-xl hover:text-purple-500 duration-200 hover:scale-110 transition-transform">{label}</a>
            </Link>
          ))}
          <a
        ...
        <div className="hidden md:flex md:flex-row md:items-center md:space-x-10">
          {[
            ...
            <Link key={href} href={href} className="group">
              <a className="text-white cursor-pointer duration-200 hover:scale-110 transition-transform hover:shadow-lg hover:text-purple-500 relative">
                <span>{label}</span>
